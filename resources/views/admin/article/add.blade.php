    ...
    <form class="layui-form" action="">
        ...
        <div class="main-container">
            <div class="layui-form-item">
                ...
                <div class="layui-col-md6">
                    <input type="text" class="layui-input" name="oldprice" placeholder="请输入原价" >
                </div>
            </div>
        </div>
        <div class="main-container">
            <div class="layui-form-item">
                ...
                <div class="layui-col-md6">
                    <input type="text" class="layui-input" name="url" placeholder="请输入下载链接" >
                </div>
            </div>
        </div>
        <div class="main-container">
