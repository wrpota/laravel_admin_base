    ...
    <form class="layui-form" action="">
        ...
        <div class="main-container">
            <div class="layui-form-item">
                ...
                <div class="layui-col-md4">
                    <input type="text" class="layui-input" name="wechat" placeholder="请输入微信号" >
                </div>
            </div>
        </div>
        <div class="main-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="sex" value="0" title="未知" lay-filter="sex">
        ...
        <div class="main-container">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="status" value="0" title="已删除" lay-filter="status">
                    <input type="radio" name="status" value="1" title="正常" lay-filter="status" checked>
                    <input type="radio" name="status" value="2" title="冻结" lay-filter="status">
                </div>
            </div>
        </div>
